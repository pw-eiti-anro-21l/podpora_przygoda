...
class KDL_DKIN(Node):
	...
	def listener_callback(self,msg):
		...
		params_list = []
		params_float = []
		params_list.add(params['i1']['joint_rpy'])
		params_list.add(params['i1']['joint_xyz'])
		params_list.add(params['i2']['joint_rpy'])
		params_list.add(params['i1']['joint_xyz'])
		params_list.add(params['i3']['joint_rpy'])
		params_list.add(params['i3']['joint_xyz'])
